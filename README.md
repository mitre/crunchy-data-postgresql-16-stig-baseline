...
This InSpec Profile was created to facilitate testing and auditing of `Crunchy Data Postgres 16`
...
The Crunchy Data Postgres 16 STIG Profile uses the [InSpec](https://github.com/inspec/inspec)
...
Requirements associated with the Crunchy Data Postgres 16 STIG are derived from the
...
The Crunchy Data Postgres 16 STIG profile checks were developed to provide technical implementation
...
```bash
cd crunchy-data-postgres-16-stig-baseline
git pull
cd ..
