...
To aid in diagnosis, it is necessary to keep track of failed attempts in addition to the successful ones.'
  desc 'check', %q(Note: The following instructions use the PGDATA and PGLOG environment variables. Refer to APPENDIX-F for instructions on configuring PGDATA and APPENDIX-I for PGLOG.
...
Unsuccessful attempts to modify security objects can be logged if logging is enabled. To ensure logging is enabled,
 review supplementary content APPENDIX-C for instructions on enabling logging.'
  ...
  tag gid: 'V-261947'
  tag rid: 'SV-261947r1000846_rule'
  tag stig_id: 'CD16-00-010300'
  tag fix_id: 'F-65709r1000845_fix'
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
