...
commands or the individual identities of shared account users.'
  desc 'check', 'Note: The following instructions use the PGDATA and PGLOG environment variables. Refer to APPENDIX-F and APPENDIX-I for instructions on configuring them.
...
To ensure logging is enabled, see the instructions in the supplementary content APPENDIX-C.'
  ...
  tag gid: 'V-261872'
  tag rid: 'SV-261872r1000621_rule'
  tag stig_id: 'CD16-00-001600'
  tag fix_id: 'F-65634r1000620_fix'
  tag cci: ['CCI-000135']
  tag nist: ['AU-3 (1)']
